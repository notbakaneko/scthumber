...
// TODO: switch to datadog or something, these stats are local to the current process only.
module.exports = function() {
  ...
  return {
    ...
    get_stats: function(req, res) {
      const total_requests = server_stats.ok + server_stats.thumb_error + server_stats.upstream_error + server_stats.arg_error;
